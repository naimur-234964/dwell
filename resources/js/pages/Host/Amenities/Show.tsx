...
interface HostAmenityShowProps { // Changed from HostPropertyShowProps
    amenity: Amenity; // Changed from property: Property & { address: Address; amenities: Amenity[]; property_images: PropertyImage[] };
}

export default function HostAmenityShow({ amenity }: HostAmenityShowProps) { // Changed from HostPropertyShow
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <Card>
                    <CardHeader className="relative">
                        <CardTitle>Amenity Details (Host)</CardTitle> {/* Changed from Property Details to Amenity Details */}
