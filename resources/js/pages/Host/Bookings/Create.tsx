...
export default function HostBookingCreate() { // Changed from HostPropertyCreate and removed amenities prop
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('host.bookings.store')); // Changed from host.properties.store to host.bookings.store
    };
    ...
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <h1 className="text-2xl font-bold mb-4">Create New Booking (Host)</h1> {/* Changed from Create New Property to Create New Booking */}
