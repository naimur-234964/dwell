...
interface HostCouponEditProps {
    coupon: Coupon;
}

const Edit: React.FC<HostCouponEditProps> = ({ coupon }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('host.coupons.update', coupon.id));
    };

    return (
        <AppLayout>
            <Head title="Edit Host Coupon" />
            <div className="p-4">
                <div className="flex justify-between items-center mb-4">
                    <h1 className="text-2xl font-bold">Edit Host Coupon</h1>
                    <Link href={route('host.coupons.index')}>
