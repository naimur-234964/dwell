...
interface HostAddressEditProps { // Changed from HostPropertyEditProps
    address: Address; // Changed from property: Property & { address: Address; amenities: Amenity[]; property_images: PropertyImage[] };
}

export default function HostAddressEdit({ address }: HostAddressEditProps) { // Changed from HostPropertyEdit and removed amenities prop
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('host.addresses.update', address.id)); // Changed from host.properties.update to host.addresses.update
    };
            ...
            <div className="p-4">
                <Card>
                    <CardHeader className="relative">
                        <CardTitle>Edit Address (Host)</CardTitle> {/* Changed from Edit Property to Edit Address */}
                        ...
                        <div className="absolute top-4 right-4">
                            <Link href="/host/addresses"> {/* Changed from /host/properties to /host/addresses */}
