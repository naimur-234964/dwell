...
export default function HostAddressCreate() { // Changed from HostPropertyCreate and removed amenities prop
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('host.addresses.store')); // Changed from host.properties.store to host.addresses.store
    };
    ...
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <h1 className="text-2xl font-bold mb-4">Create New Address (Host)</h1> {/* Changed from Create New Property to Create New Address */}
