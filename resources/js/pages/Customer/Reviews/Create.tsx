...
export default function CustomerReviewCreate() { // Changed from HostPropertyCreate and removed amenities prop
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('customer.reviews.store')); // Changed from host.properties.store to customer.reviews.store
    };
    ...
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <h1 className="text-2xl font-bold mb-4">Create New Review (Customer)</h1> {/* Changed from Create New Property to Create New Review */}
