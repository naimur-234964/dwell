...
interface CustomerReviewShowProps { // Changed from HostPropertyShowProps
    review: Review; // Changed from property: Property & { address: Address; amenities: Amenity[]; property_images: PropertyImage[] };
}

export default function CustomerReviewShow({ review }: CustomerReviewShowProps) { // Changed from HostPropertyShow
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <Card>
                    <CardHeader className="relative">
                        <CardTitle>Review Details (Customer)</CardTitle> {/* Changed from Property Details to Review Details */}
