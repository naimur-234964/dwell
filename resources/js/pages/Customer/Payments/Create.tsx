...
export default function CustomerPaymentCreate() { // Changed from HostPropertyCreate and removed amenities prop
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('customer.payments.store')); // Changed from host.properties.store to customer.payments.store
    };
    ...
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <h1 className="text-2xl font-bold mb-4">Create New Payment (Customer)</h1> {/* Changed from Create New Property to Create New Payment */}
