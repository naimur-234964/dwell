...
interface CustomerPaymentShowProps { // Changed from HostPropertyShowProps
    payment: Payment; // Changed from property: Property & { address: Address; amenities: Amenity[]; property_images: PropertyImage[] };
}

export default function CustomerPaymentShow({ payment }: CustomerPaymentShowProps) { // Changed from HostPropertyShow
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <Card>
                    <CardHeader className="relative">
                        <CardTitle>Payment Details (Customer)</CardTitle> {/* Changed from Property Details to Payment Details */}
