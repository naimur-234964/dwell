...
export default function CustomerBookingCreate() { // Changed from HostPropertyCreate and removed amenities prop
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('customer.bookings.store')); // Changed from host.properties.store to customer.bookings.store
    };
    ...
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <h1 className="text-2xl font-bold mb-4">Create New Booking (Customer)</h1> {/* Changed from Create New Property to Create New Booking */}
