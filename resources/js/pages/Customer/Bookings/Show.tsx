...
interface CustomerBookingShowProps { // Changed from HostPropertyShowProps
    booking: Booking; // Changed from property: Property & { address: Address; amenities: Amenity[]; property_images: PropertyImage[] };
}

export default function CustomerBookingShow({ booking }: CustomerBookingShowProps) { // Changed from HostPropertyShow
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <Card>
                    <CardHeader className="relative">
                        <CardTitle>Booking Details (Customer)</CardTitle> {/* Changed from Property Details to Booking Details */}
