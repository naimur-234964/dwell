...
export default function AdminPaymentCreate() { // Changed from AdminPropertyCreate and removed amenities prop
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.payments.store')); // Changed from admin.properties.store to admin.payments.store
    };
    ...
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <h1 className="text-2xl font-bold mb-4">Create New Payment (Admin)</h1> {/* Changed from Create New Property to Create New Payment */}
