...
interface AdminPaymentShowProps { // Changed from AdminPropertyShowProps
    payment: Payment; // Changed from property: Property & { address: Address; amenities: Amenity[]; property_images: PropertyImage[] };
}

export default function AdminPaymentShow({ payment }: AdminPaymentShowProps) { // Changed from AdminPropertyShow
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <Card>
                    <CardHeader className="relative">
                        <CardTitle>Payment Details (Admin)</CardTitle> {/* Changed from Property Details to Payment Details */}
