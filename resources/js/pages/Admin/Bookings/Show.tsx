...
interface AdminBookingShowProps { // Changed from AdminPropertyShowProps
    booking: Booking; // Changed from property: Property & { address: Address; amenities: Amenity[]; property_images: PropertyImage[] };
}

export default function AdminBookingShow({ booking }: AdminBookingShowProps) { // Changed from AdminPropertyShow
    return (
        <AppLayout>
            ...
            <div className="p-4">
                <Card>
                    <CardHeader className="relative">
                        <CardTitle>Booking Details (Admin)</CardTitle> {/* Changed from Property Details to Booking Details */}
